...
export default function Home() {
  const stats = [
    { icon: <Briefcase className="w-6 h-6 text-red-500" />, value: '28+', label: 'Years' },
    { icon: <Globe className="w-6 h-6 text-red-500" />, value: '15+', label: 'Country' },
    { icon: <Building2 className="w-6 h-6 text-slate-500" />, value: '15+', label: 'Industries' },
    { icon: <Users className="w-6 h-6 text-red-500" />, value: '30+', label: 'Experts' },
    { icon: <CheckCircle className="w-6 h-6 text-red-500" />, value: '8K+', label: 'Projects' },
    { icon: <Smile className="w-6 h-6 text-red-500" />, value: '5K+', label: 'Customers' },
  ];
  ...
  const whyChooseUs = [
    ...
    {
      icon: <LinkIcon className="w-8 h-8 text-red-500" />,
      title: 'Integration',
  ...
  const products = [
    { icon: <ShoppingCart className="w-5 h-5 text-red-500" />, title: 'Supermarket ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Optimize your retail operations with our software, simplifying accounting, inventory, sales, and purchase processes.' },
    { icon: <Car className="w-5 h-5 text-red-500" />, title: 'Automotive ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Optimize automotive operations with integrated tools for inventory, sales, service management, and customer engagement.' },
    { icon: <Truck className="w-5 h-5 text-red-500" />, title: 'Distribution ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Streamline supply chain operations with advanced tools for inventory, logistics, and vendor management.' },
    { icon: <Building2 className="w-5 h-5 text-red-500" />, title: 'Hospital ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Streamline hospital operations with comprehensive tools for patient care, billing, inventory, and regulatory compliance.' },
    { icon: <Stethoscope className="w-5 h-5 text-red-500" />, title: 'Clinic ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Enhance clinic efficiency with tailored solutions for patient care, scheduling, billing, and streamlined operations.' },
    { icon: <Pill className="w-5 h-5 text-red-500" />, title: 'Pharmacy ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Optimize your pharmacy operations with advanced tools for inventory, billing, sales tracking, and regulatory compliance.' },
    { icon: <Hotel className="w-5 h-5 text-red-500" />, title: 'Hotel ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Streamline hotel operations and enhance guest experiences with our all-in-one hotel management solution.' },
    { icon: <Utensils className="w-5 h-5 text-red-500" />, title: 'Restaurant ERP', tags: 'On-Premises · Cloud · Hybrid', desc: 'Optimize restaurant operations and enhance customer satisfaction with our comprehensive restaurant management system.' },
  ];
    ...
    <div className="flex flex-col">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-bold tracking-tight mb-6 leading-tight">
              Transform Your Business with <span className="text-[#d32f2f]">Intelligent ERP</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/contact" className="bg-[#d32f2f] text-white px-8 py-4 rounded-md font-medium hover:bg-red-700 transition-colors flex items-center gap-2 text-lg">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl font-bold text-slate-800 mb-2">
              <span className="text-[#d32f2f] mr-2">|</span>Why Choose <span className="text-[#d32f2f]">Rapid ERP</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-br from-red-50 to-red-100 relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 opacity-40">
           ...
           <div className="absolute top-1/2 right-0 w-64 h-64 bg-red-200 rounded-full blur-3xl"></div>
        </div>
        
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex justify-between items-end mb-10">
            <h2 className="text-4xl font-bold text-slate-800">
              <span className="text-[#d32f2f] mr-2">|</span>Explore by <span className="text-[#d32f2f]">Products</span>
            </h2>
            ...
            {products.map((product, idx) => (
              <div key={idx} className="bg-white p-6 rounded-xl shadow-sm hover:shadow-md transition-shadow border border-white/50">
                <div className="flex items-start gap-4 mb-4">
                  <div className="p-2 bg-red-50 rounded-lg">{product.icon}</div>
                  <div>
                ...
                <div className="flex justify-end">
                  <button className="text-[#d32f2f] text-sm font-medium flex items-center gap-1 hover:underline">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-end mb-10">
          <h2 className="text-4xl font-bold text-slate-800">
            <span className="text-[#d32f2f] mr-2">|</span>Explore solutions by <span className="text-[#d32f2f]">Industry</span>
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {industries.map((ind, idx) => (
            <Link key={idx} to="/industries" className="flex flex-col items-center justify-center p-6 border border-slate-200 rounded-xl hover:border-[#d32f2f] hover:text-[#d32f2f] transition-colors group text-slate-600">
              <div className="mb-3 text-[#d32f2f] group-hover:scale-110 transition-transform">{ind.icon}</div>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            <h2 className="text-4xl font-bold text-slate-800">
              <span className="text-[#d32f2f] mr-2">|</span>Our <span className="text-[#d32f2f]">Services</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {services.map((service, idx) => (
              <Link key={idx} to="/services" className="flex items-center justify-between p-6 bg-white border border-slate-200 rounded-xl hover:border-[#d32f2f] hover:shadow-sm transition-all group">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-red-50 flex items-center justify-center text-[#d32f2f]">
                    <Settings className="w-5 h-5" />
                  </div>
                  <span className="font-medium text-slate-800 group-hover:text-[#d32f2f] transition-colors">{service}</span>
                </div>
      ...
      <section className="py-20 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
          <h2 className="text-4xl font-bold text-slate-800">
            <span className="text-[#d32f2f] mr-2">|</span>What <span className="text-[#d32f2f]">Our Clients</span> Says
          </h2>
        </div>
              ...
              <div key={idx} className="w-[320px] md:w-[450px] flex-shrink-0 px-4">
                <div className="bg-white rounded-xl shadow-sm overflow-hidden flex flex-col h-full border border-slate-100">
                  <div className="p-8 flex-grow relative">
                    <div className="absolute top-6 left-6 text-6xl text-red-100 font-serif leading-none">"</div>
                    <p className="text-slate-600 relative z-10 text-sm leading-relaxed italic mt-4">
                      {testimonial.text}
                    </p>
                  </div>
                  <div className="bg-[#d32f2f] p-4 text-white flex items-center gap-4 mt-auto">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-red-100">{testimonial.role}</div>
                    </div>
                  </div>
                </div>
              </div>
