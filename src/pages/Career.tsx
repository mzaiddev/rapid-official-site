  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="bg-slate-800 text-white py-20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#28a8e0] opacity-20 rounded-l-full blur-3xl transform translate-x-1/3"></div>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="text-3xl font-bold text-slate-800 mb-8">
          <span className="text-[#28a8e0] mr-2">|</span>Open Positions
        </h2>
        
        <div className="space-y-4">
          {jobs.map((job, idx) => (
            <div key={idx} className="bg-white border border-slate-200 p-6 rounded-xl hover:border-[#28a8e0] hover:shadow-md transition-all flex flex-col md:flex-row md:items-center justify-between gap-4 group">
              <div>
                <div className="text-xs font-semibold text-[#28a8e0] uppercase tracking-wider mb-2">{job.dept}</div>
                <h3 className="text-xl font-bold text-slate-800 mb-2 group-hover:text-[#28a8e0] transition-colors">{job.title}</h3>
              ...
              <button 
                ...
                className="bg-slate-100 text-slate-700 px-6 py-2 rounded-md font-medium hover:bg-[#28a8e0] hover:text-white transition-colors flex items-center gap-2 w-fit"
              >
            ...
            <div className="p-6">
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input type="tel" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#28a8e0] focus:border-transparent outline-none transition-all" placeholder="+1 (555) 000-0000" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">LinkedIn Profile URL</label>
                  <input type="url" className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#28a8e0] focus:border-transparent outline-none transition-all" placeholder="https://linkedin.com/in/johndoe" />
                </div>

                <div>
                  <label className="block text-sm font-medium text-slate-700 mb-2">Resume / CV</label>
                  <div className="border-2 border-dashed border-slate-300 rounded-lg p-8 text-center hover:border-[#28a8e0] transition-colors cursor-pointer bg-slate-50">
                ...
                <div>
                  ...
                  <textarea rows={4} className="w-full px-4 py-3 rounded-lg border border-slate-300 focus:ring-2 focus:ring-[#28a8e0] focus:border-transparent outline-none transition-all resize-none" placeholder="Tell us why you're a great fit..."></textarea>
                </div>

                <button type="button" className="w-full bg-[#28a8e0] text-white px-6 py-4 rounded-lg font-bold hover:bg-sky-600 transition-colors text-lg">
                  Submit Application
                </button>
              </form>
            </div>
