...
const AboutMegaMenu = ({
  ...
  const items = [
    ...
    {
      name: "Career",
      desc: "Exciting opportunities to grow.",
      path: "/career",
      icon: Briefcase,
    },
  ];
            ...
            >
              ...
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-1">
                  <span className="font-bold text-slate-900 group-hover:text-brand-primary transition-colors">
                    {item.name}
                  </span>
                </div>
    ...
    [
      {
        ...
        desc: "Streamline and integrate your business operations with custom ERP solutions built to fit your unique needs.",
        isNew: false,
        icon: Database,
      },
      {
        name: "Web Development",
        desc: "Build a strong digital presence with modern, high-performing websites tailored to your business goals.",
        isNew: false,
        icon: LayoutIcon,
      },
      {
        name: "App Development",
        desc: "Turn your ideas into powerful mobile applications that engage users and drive business growth.",
        isNew: false,
        icon: Smartphone,
      },
      {
        name: "UI / UX Design",
        desc: "Create meaningful and engaging digital experiences with our user-centric UI/UX design services.",
        isNew: false,
        icon: PenTool,
      },
    ],
    [
      {
        ...
        desc: "Streamline communication between your applications and systems with our reliable middleware solutions.",
        isNew: false,
        icon: Server,
      },
      {
        name: "BigData Solutions",
        desc: "Unlock the power of your data with advanced big data solutions.",
        isNew: false,
        icon: Activity,
      },
      {
        name: "RFID Solutions",
        desc: "Enhance tracking, security, and automation with our RFID (Radio Frequency Identification) solutions.",
        isNew: false,
        icon: Scan,
      },
      {
        name: "Biometric Solutions",
        desc: "Secure and simplify identity verification with advanced biometric solutions.",
        isNew: false,
        icon: Fingerprint,
      },
    ],
    [
      {
        ...
        desc: "Transform your business with intelligent, data-driven solutions.",
        isNew: true,
        icon: BrainCircuit,
      },
      {
        name: "IoT Solutions",
        desc: "Connect, monitor, and control your devices with our end-to-end Internet of Things (IoT) solutions.",
        isNew: true,
        icon: Cpu,
      },
      {
        name: "CyberSecurity",
        desc: "Protect your digital assets with robust, proactive cybersecurity solutions.",
        isNew: true,
        icon: ShieldCheck,
      },
      {
        name: "DevOps",
        desc: "Accelerate your software delivery with our DevOps expertise.",
        isNew: true,
        icon: Infinity,
      },
    ],
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-1">
                      ...
                      {item.isNew && (
                        <span className="px-2 py-0.5 rounded-md bg-emerald-100 text-emerald-700 text-[10px] font-extrabold uppercase tracking-widest">
                          New
                        </span>
                      )}
                    </div>
...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-800 bg-[#111624] selection:bg-brand-primary/20 selection:text-brand-primary">
      {/* Navbar */}
      <header
        className={cn(
                ...
                <div key={link.name} className="relative group">
                  <button
                    ...
                    className={cn(
                      ...
                      location.pathname === link.path && !link.hasItems
                        ? "text-brand-primary"
      ...
      {/* Main Content */}
      <main className="flex-grow pt-20 lg:pt-22 min-h-screen">
        <Outlet />
      </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div className="lg:pr-4">
              ...
              <p className="text-sm text-slate-400 mb-8 leading-relaxed">
                Rapid ERP, our software stands as a symbol of precision,
                quality, and trust for all your enterprise needs.
              </p>
              <div className="flex items-center gap-3 text-sm font-bold text-white">
                ...
                <div className="flex gap-2">
                  <a
                    href="#"
                    className="w-8 h-8 rounded-full border border-slate-700 flex items-center justify-center hover:bg-brand-primary hover:border-brand-primary hover:text-white transition-all"
                  >
            ...
            <div>
              ...
              <ul className="space-y-3 font-medium text-slate-400 text-sm">
                <li className="flex items-center gap-2 group">
                  <ChevronRight className="w-3.5 h-3.5 text-brand-primary transition-transform group-hover:translate-x-1" />
